...
class RegisterNewUser(unittest.TestCase):
	...
	def test_new_user(self):
		...
		create_account_button = driver.find_element('xpath', '/html/body/div/div[2]/div[2]/div/div/div[2]/form/div/div[1]/div[2]/a/span/span')
		...
		submit_button = driver.find_element('xpath', '/html/body/div/div[2]/div[2]/div/div/div[2]/form/div[2]/button')
		...
		last_name.send_keys('Testtest@mailito.com') #sacado de 10-minute mail
